      ...
      <div className="flex flex-col items-center justify-center my-4 bg-yellow-200 rounded-b-xl">
        <div className="text-center">
          <div className="w-full flex justify-center items-center my-2">
            <svg width="3em" height="3em" fill="currentColor" viewBox="0 0 512 512">
          ...
          <p className="text-gray-600 mt-2 mb-4">Mientras tanto, aquí tienes algunos videos de prueba:</p>
        </div>
      </div>
