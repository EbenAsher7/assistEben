  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: "space-y-2",
        caption: "flex justify-center pt-1 relative items-center text-black inline-flex text-[0px]",
        caption_label: "text-sm font-medium text-black dark:text-white inline-flex text-xl ml-3",
