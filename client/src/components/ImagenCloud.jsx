    ...
    <div className="relative flex flex-col items-center">
      <div className="relative">
        {localUrl ? (
          ...
          <div
            className={`bg-gray-300 ${rounded ? "rounded-full border-2 border-black dark:border-white" : ""}`}
            style={{ width: size + "px", height: size + "px" }}
          ></div>
        )}
      ...
      {upload && (
        <>
          ...
          <button onClick={() => fileInputRef.current.click()} className="bg-blue-500 text-white mt-2 p-2 rounded-full ">
            Subir imagen
          </button>
        </>
      )}
